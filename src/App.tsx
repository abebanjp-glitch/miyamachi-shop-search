...
import OmiyamachiLogo from './components/OmiyamachiLogo';
        ...
        <div className="max-w-[1500px] mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-4 w-full" id="logo-container">
            <div className="flex items-center justify-center gap-4 flex-nowrap whitespace-nowrap">
              ...
              >
                <OmiyamachiLogo className="w-[108px] sm:w-[220px] h-auto" />
              </motion.div>
              <div className="text-left border-l border-black/[0.08] pl-5 py-2 whitespace-nowrap">
                <motion.div 
                  className="h-[40px] sm:h-[72px] flex items-center whitespace-nowrap"
                ...
                <motion.p 
                  className="text-[9px] tracking-[0.22em] text-brand-charcoal/50 font-semibold uppercase mt-3.5 leading-none whitespace-nowrap"
